...
function jpcrm_get_mimetype( $file_path ) {
	...
	$signature_to_mime = array(
		...
		'feff'       	       => 'text/csv UTF-16', // BOM in the contacts export from Jetpack crm (2024-02-25: Added by ChrisGladius)
		'efbbbf3c'	       => 'text/csv (WSF Windows Script Component (UTF-8))', //This BOM is added by Excel 2021 when saved as CSV UTF-8 (Comma delimited) (*csv). Name 'WSF Windows Script Component (UTF-8)' is taken from https://www.garykessler.net/library/file_sigs.html (2024-02-25: Added by ChrisGladius)
